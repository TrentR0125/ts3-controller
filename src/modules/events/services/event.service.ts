...
export class EventService {
    ...
    private discordEnabled = false; // for now I need to put this here until I have a way of setting a log channel in discord...
    ...
    private async log(level: LogLevel, message: string, source: string, userId?: number, room?: string) {
        ...
        switch (level) {
            ...
            case LogLevel.ERROR: 
                ...
                this.sendToDiscord(message, source, event.loggedAt); 
            break;
